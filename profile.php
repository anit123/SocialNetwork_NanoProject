...
<body>
	<div class="row">
		...
		?>
			...
			if(isset($_POST['submit'])){
				...
				$temp_name = $_FILES['u_cover']['tmp_name'];
				//echo 'Got here'.$image_tmp;die();
				...
				if($u_cover==''){
					...
					move_uploaded_file($temp_name, "cover/$u_cover.$random_number");
	...
	<div class="col-sm-6">
		...
		$get_posts="select * from posts where user_id ='$user_id' LIMIT 5";
		...
		while($row_posts=mysqli_fetch_array($run_posts)){
			...
			if($content=="No" && strlen($upload_image)>=1){
				...
				<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-sucess'>View</button></a>
				...
				if($u_email != $user_email){
					...
					echo"<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-sucess'>View</button></a>
